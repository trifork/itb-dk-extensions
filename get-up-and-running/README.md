...
| `Caddyfile` | Routes HTTPS to the UI gateway on 9000, callbacks on 8080, and the validator on 8080 via public port 8443; automatically obtains and renews certificates. | `compose.https.yml` |
