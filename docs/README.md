...
| `xds.md` | Enabling and configuring the optional IHE XDS integration for finding CDA documents in the Danish Document Sharing Service (DDS): credentials and vault password, TEST1 endpoints, repository labels, Docker Hub publication, verification and troubleshooting. |
